document.addEventListener("DOMContentLoaded", function() {
  const responses = {
    ...
    "experience": "Store Clerk(Giant Food), Administrative Assistant ll(University of Maryland Extension), IT Specialist(University of Maryland Extension).",
  ...
  function sendMessage() {
    ...
    const message = userInputElem.value.toLowerCase().trim();  // <-- Corrected here
